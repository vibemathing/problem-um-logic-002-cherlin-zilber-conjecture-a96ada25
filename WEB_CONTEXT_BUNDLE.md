...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-logic-002-cherlin-zilber-conjecture-a96ada25-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/LOGIC-002"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-logic-002-cherlin-zilber-conjecture-a96ada25-v1",
      "problem_contract_sha256": "3b984b892a086d9212de26dcf6f24b39d101e7578143446d0f0d8cb86c867f2a",
      "problem_id": "problem:um-logic-002-cherlin-zilber-conjecture-a96ada25",
      "route_id": "route:um-logic-002-cherlin-zilber-conjecture-a96ada25-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-logic-002-cherlin-zilber-conjecture-a96ada25-source-fidelity-01",
      "graph_id": "graph:um-logic-002-cherlin-zilber-conjecture-a96ada25-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-logic-002-cherlin-zilber-conjecture-a96ada25-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-logic-002-cherlin-zilber-conjecture-a96ada25-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is every simple group with $\\aleph_0$-stable theory an algebraic group over an algebraically closed field?"
          },
          "statement_sha256": "26f66e7b737ba2c0df1ddedaa7a22acd08a9c838f51e2361da7f7367c2931eeb"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-logic-002-cherlin-zilber-conjecture-a96ada25-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-logic-002-cherlin-zilber-conjecture-a96ada25-root",
      "route_id": "route:um-logic-002-cherlin-zilber-conjecture-a96ada25-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-logic-002-340b3155472e",
        "url": "https://www.unsolvedmath.com/problems/LOGIC-002"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
